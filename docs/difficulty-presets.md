...
- **FRU** — free-recall-unordered (type names in any order)
...
| Medium | FRU      | hands **on**, feet **on**, teeth **off**   |
| Hard   | PR       | hands **on**, feet **on**, teeth **off**   |
...
- **Human Bones (3D)** follows the standard Identify → FRU → PR escalation (Locate is available as a mode but not used as a preset).
