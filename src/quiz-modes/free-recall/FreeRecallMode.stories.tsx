...
const sampleElements: ReadonlyArray<GridElement> = [
  { id: 'H', label: 'Hydrogen', symbol: 'H', row: 0, column: 0, viewBoxCenter: { x: 30, y: 30 }, viewBoxBounds: { minX: 0, minY: 0, maxX: 60, maxY: 60 }, interactive: true, group: 'nonmetal' },
  { id: 'He', label: 'Helium', symbol: 'He', row: 0, column: 1, viewBoxCenter: { x: 94, y: 30 }, viewBoxBounds: { minX: 64, minY: 0, maxX: 124, maxY: 60 }, interactive: true, group: 'noble-gas' },
  { id: 'Li', label: 'Lithium', symbol: 'Li', row: 1, column: 0, viewBoxCenter: { x: 30, y: 94 }, viewBoxBounds: { minX: 0, minY: 64, maxX: 60, maxY: 124 }, interactive: true, group: 'alkali-metal' },
  { id: 'Be', label: 'Beryllium', symbol: 'Be', row: 1, column: 1, viewBoxCenter: { x: 94, y: 94 }, viewBoxBounds: { minX: 64, minY: 64, maxX: 124, maxY: 124 }, interactive: true, group: 'alkaline-earth' },
  { id: 'B', label: 'Boron', symbol: 'B', row: 1, column: 2, viewBoxCenter: { x: 158, y: 94 }, viewBoxBounds: { minX: 128, minY: 64, maxX: 188, maxY: 124 }, interactive: true, group: 'metalloid' },
  { id: 'C', label: 'Carbon', symbol: 'C', row: 1, column: 3, viewBoxCenter: { x: 222, y: 94 }, viewBoxBounds: { minX: 192, minY: 64, maxX: 252, maxY: 124 }, interactive: true, group: 'nonmetal' },
  { id: 'N', label: 'Nitrogen', symbol: 'N', row: 1, column: 4, viewBoxCenter: { x: 286, y: 94 }, viewBoxBounds: { minX: 256, minY: 64, maxX: 316, maxY: 124 }, interactive: true, group: 'nonmetal' },
  { id: 'O', label: 'Oxygen', symbol: 'O', row: 1, column: 5, viewBoxCenter: { x: 350, y: 94 }, viewBoxBounds: { minX: 320, minY: 64, maxX: 380, maxY: 124 }, interactive: true, group: 'nonmetal' },
  { id: 'F', label: 'Fluorine', symbol: 'F', row: 1, column: 6, viewBoxCenter: { x: 414, y: 94 }, viewBoxBounds: { minX: 384, minY: 64, maxX: 444, maxY: 124 }, interactive: true, group: 'halogen' },
  { id: 'Ne', label: 'Neon', symbol: 'Ne', row: 1, column: 7, viewBoxCenter: { x: 478, y: 94 }, viewBoxBounds: { minX: 448, minY: 64, maxX: 508, maxY: 124 }, interactive: true, group: 'noble-gas' },
];
